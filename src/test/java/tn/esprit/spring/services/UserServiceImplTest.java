...
class UserServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        sampleUser = new User(1L, "John", "Doe", new Date(0), Role.INGENIEUR);
    }
    ...
    void updateUser_ShouldReturnUpdatedUser() {
        // Arrange
        User updated = new User(1L, "Jane", "Doe", new Date(0), Role.ADMINISTRATEUR);
        ...
        // Assert
        assertNotNull(result);
        assertEquals(Role.ADMINISTRATEUR, result.getRole());
